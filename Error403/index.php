				...
				<center>
					<div style='height:115px;'></div> <!-- SPACE -->
						<div id='platform' style='width:1200px; border:1px solid black;background-color:white;border-radius:10px;padding:20px;'>
							<text style='color:black;font-size:24px;'>Error 403</text> <br><br>
							<text style='color:black;font-size:18px;'>Forbidden</text><br> <br>
							<text style='color:gray;font-size:14px;'>You do not have access to this page.</text>
						</div>
					</div>
				</center>
			</body>";
