					...
					if(is_numeric($tableId)){
						...
						if($hasThreads > 0){
							...
							while ($pinnedThreads = mysqli_fetch_array($pinnedThreadsQ)) {
								...
								echo"<a href='thread.php?id=$pinnedThreads[0]'><div id='platform' style='text-align:left;width:900px; margin-bottom:10px; border:0px solid black;background-color:white;padding:20px;'>
							...
							echo"<a href='thread.php?id=$threads[0]'><div id='platform' style='text-align:left;width:900px; margin-bottom:10px; border:0px solid black;background-color:white;padding:20px;'>
