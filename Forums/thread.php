		...
		if($account > 0){
			...
			echo"
				<center>
					...
					echo"
						<div id='platform' style='width:1200px; border:0px solid black;background-color:white;padding:20px;'>
						...
						<div>
							...
							<div style='display:inline-block;width:1050px;margin:0px;'>
								<div style='display:inline-block;width:600px;margin-right:100px;'>
									<text style='font-size:15px;word-wrap: break-word;text-align:left;'>$OP[BODY]<br><br>$OPUser[FORUM_SIG]</text><br><br>";
				...
				while($replies = mysqli_fetch_array($repliesQ)){
					...
					echo"
						<div id='platform' style='width:1200px; border:0px solid black;background-color:white;padding:20px;margin-top:5px;'>
						...
						<div style='display:inline-block;'>
							...
							<div style='display:inline-block;width:1050px;margin:0px;'>
								<div style='display:inline-block;width:600px;margin-right:100px;'>
									<text style='font-size:15px;word-wrap: break-word;text-align:left;'>$replies[BODY]<br><br>$RUser[FORUM_SIG]</text><br><br>";
									// If not member, give mod tools
									if($user['POWER']!= "MEMBER"){
				...
				<center><Br><br>
					<a style='font-size:10px;background-color:white;border:0px solid;padding:2.5px;padding-right:30px;padding-left:30px;' onclick='goBack()'>Go back</a>";
					if($OP['LOCKED']=='YES'){
						echo" <a style='background-color:white; color:grey;border:0px solid grey;padding:5px;padding-right:30px;padding-left:30px;' disabled>Reply</a>";
					}else{
						echo" <a style='background-color:white;border:0px solid;padding:5px;padding-right:30px;padding-left:30px;' href='Reply.php?id=$threadId'>Reply</a>";
					} 
					echo"
					<a style='font-size:10px;background-color:white;border:0px solid;padding:2.5px;padding-right:30px;padding-left:30px;' href='thread.php?id=$threadId&page=$newPage'>Next page?</a>	
					<script>
					function goBack() {
					    window.history.back();
					}
