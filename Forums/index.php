			...
			echo"
				<center>
					...
					while($forum = mysqli_fetch_array($forumQ)){
						echo"<a href='table.php?id=$forum[0]'><div id='platform' style='text-align:left;width:1200px; margin-bottom:10px; border:0px solid black;background-color:white;padding:20px;'>
