<title>Latericius</title>
<link rel="icon" href="https://cdn.discordapp.com/icons/343015581726801920/36868c4e64dcaa397a57fd9da4a553e4.png" type="image/x-icon"/>
<?php
...
$maintenance = 1; // 1 = on for all you non programmers
if($maintenance == 1){
	// if header has "maintain" then redirect
}else{	
	if($user['USERNAME']=='Latericius'){ // u can add mroe people
		...
		if (strpos($_SERVER['REQUEST_URI'], "maintain") !== false){
			...
			<center style='font-family:Arial, Terminal;'>
				<text style='font-size:60px;font-weight:bold;position:fixed;left:20%;top:35%;'>Latericius is in<br>Maintenance<br><br>
...
<head>
	...
	<script>
		...
		function Bell(){
			window.location='/Mod/assets.php'
		}
	}
	// my eyes only sshhhh
	</script>
...
<div style='width:100%;z-index:2;background-color:white;color:black;padding:10px;border:1px solid black;border-top:0px;border-radius-bottom-left:5px;border-radius-bottom-right:5px;position: fixed;' id='navbar'>
	<!--<a style='margin-right:5.5px;margin-left:5.5px;color:grey;' href='#'>LOGO</a>-->  <a style='margin-right:5.5px;margin-left:5.5px;' href='/Dashboard/'>Dashboard</a>  |  <a style='margin-right:5.5px;margin-left:5.5px;' href='/Marketplace/'>Marketplace</a>  |  <a style='margin-right:5.5px;margin-left:5.5px;' href='/Play/'>Play</a>  |  <a style='margin-right:5.5px;margin-left:5.5px;' href='/Forums/'>Forums</a>  |  <a style='margin-right:5.5px;margin-left:5.5px;' href='/Upgrade/'>Upgrade</a>  |  <a style='margin-right:5.5px;margin-left:5.5px;' href='/News/'>News</a>  |  <a style='margin-right:5.5px;margin-left:5.5px;' href='/Search/'>Search</a>  |  <a style='margin-right:5.5px;margin-left:5.5px;' href='/Friends/'>Friends</a>    |  <a style='margin-right:5.5px;margin-left:5.5px;' href='https://discord.gg/warEDUZ'>Discord</a>
	";
		...
		<div>
			...
			<div style='float:right;width:145px;font-size:20px;padding-left:20px;' >
				...
				if($user['POWER']!=='MEMBER' && $user['POWER']!=='MODERATOR'){
					...
					if($areAssets > 0){
						echo"<a href='../Mod/assets.php' style='margin-right:7.5px;margin-left:7.5px;color:grey;' class='fa fa-bell'>
						...
						echo"<a href='../Mod/assets.php' style='margin-right:7.5px;margin-left:7.5px;color:grey;' class='fa fa-bell'></a>";
					}
				}
...
<!-- Use for alert only, comment out with HTML comment RED for danger, ORANGE for warning, GREEN for notice -->
 <div style='color:white;width:99.9%;background-color:green;padding:10px;padding-top:60px;position:fixed;z-index:-1;'>
	<center>
		<b>Welcome to Latericius.</b>.
	</center>
</div> 
